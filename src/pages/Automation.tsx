      ...
      <div className="max-w-[1280px] mx-auto space-y-6">
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="app-heading text-2xl font-bold text-gray-900">Room Automation</h1>
              <p className="app-text text-gray-600 mt-1">Select a room to manage its devices and settings</p>
            </div>
            <Button 
              onClick={() => setShowAddModal(true)}
              className="bg-blue-600 hover:bg-blue-700 app-text"
            >
          ...
          <div className="relative flex-1">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 app-icon" />
            <Input
              placeholder="Search rooms..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="pl-10 app-text"
            />
          </div>
        </div>
        ...
        {filteredRooms.length > 0 ? (
          ...
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Plus className="app-icon text-gray-400" />
            </div>
            <h3 className="app-text text-lg font-semibold text-gray-900 mb-2">No rooms found</h3>
