...
('safety', 'fire_detection', '{"supported_states": {"status": "safe|alert|active", "flame_status": "clear|flames", "temperature": "number", "smoke_percentage": "number"}, "actions": ["manual_suppression", "sensor_test"]}'),
('safety', 'rain_detection', '{"supported_states": {"status": "safe|alert", "rain_detected": "boolean", "window_status": "open|closed"}, "actions": ["open_window", "close_window", "override_timer"]}'),
('safety', 'gas_leak', '{"supported_states": {"status": "safe|alert", "gas_level": "number", "sensitivity": "low|medium|high"}, "actions": ["ventilation_control", "auto_open_windows"]}'),
('safety', 'water_overflow', '{"supported_states": {"status": "safe|alert", "water_level": "number", "min_level": "number", "max_level": "number", "auto_pump": "boolean"}, "actions": ["pump_control", "level_calibration"]}'),
('security', 'door_control', '{"supported_states": {"lock_status": "locked|unlocked", "security_mode": "home|away", "last_action": "timestamp"}, "actions": ["lock", "unlock", "set_mode"]}');
