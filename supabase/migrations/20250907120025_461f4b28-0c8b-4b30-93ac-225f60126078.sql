...
-- 5. Update RLS policies for admin_ander_commands to allow read access for all authenticated users
...
-- 6. Create policy for admin users to update global commands
...
-- 7. Populate initial global commands if they don't exist
...
-- 8. Create an index for faster keyword searches
